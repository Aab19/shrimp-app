...
const CardPrice = props => {
  ...
  return (
    <View className={`p-3 border border-[#E5E5E5] rounded-[4px] ${props.idx !== 0 && 'mt-2'}`}>
      <View className="flex-row justify-between">
        ...
        <View
          className={`flex-row items-center ${
            creator && creator.buyer == null ? 'bg-[#E5E5E5] px-2 py-1 ' : 'bg-[#FFF8E7] p-1'
          }  rounded-[28px]  h-[22px]`}>
      ...
      <View>
        <TextView
          ...
          customStyle={gstyles.blueText}
        />
        <TextView content={provinceName} customClass="text-[12px] mt-1 leading-4" />
        <TextView
          content={regencyName}
